    ...
    return (
        <div className={styles.page}>
            ...
            <nav className={styles.nav}>
                ...
                <Link to="/albunes" className={styles.link}>ÁLBUMES</Link>
                <Link to="/grupo" className={styles.link}>GRUPO</Link>
            </nav>
            ...
            <section className={styles.info}>
                ...
                <p>
                    AC/DC es pura energía sin filtro. Riffs pesados, actitud callejera y
                    una identidad visual marcada por el rayo y la potencia del hard rock.
                </p>
                <p>
                    Desde Australia al mundo, su sonido es una explosión constante de electricidad musical.
                </p>
            </section>
